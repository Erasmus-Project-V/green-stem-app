...
class Vector:
    ...
    def __mul__(self, other):
        if other.__class__ in (int,float):
            ...
            if not other.dimension == self.dimension: raise ArithmeticError(f"Tried to multiply vectors of dimensions: {self.dimension} and {other.dimension},"
    ...
    def __add__(self, other):
        if other.__class__ in (int,float):
            ...
            if not other.dimension == self.dimension: raise ArithmeticError(f"Tried to add vectors of dimensions: {self.dimension} and {other.dimension},"
                                                                            f"\n Sentenced to math jail.")
